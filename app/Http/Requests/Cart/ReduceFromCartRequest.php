...
class ReduceFromCartRequest extends FormRequest
{

    /**
     * @OA\Schema(
     *     title="Reduce From Cart",
     *     description="Reduce From Cart request",
     *     schema="ReduceFromCartRequestSchema",
     *     required={"id", "count"},
     *      @OA\Property(
     *           property="id",
     *           type="string",
     ...
     * @OA\Schema(
     *     title="Reduce From Cart",
     *     description="Reduce From Cart validation messages",
     *     schema="ReduceFromCartRequestMessagesSchema",
     *          @OA\Property(
     *              property="id",
     *              type="string",
