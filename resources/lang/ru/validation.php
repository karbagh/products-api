...
return [
    ...
    */
    ...
    'doesnt_end_with' => ':attribute не может заканчиваться одним из следующих символов: :ценности.',
    'doesnt_start_with' => ':attribute не может начинаться с одного из следующих: :ценности.',
    'email' => ':attribute должен быть действительным адресом электронной почты.',
    'ends_with' => ':attribute должен заканчиваться одним из следующих символов: :ценности.',
    ...
    'lte' => [
        'array' => ':attribute не должен содержать больше элементов :value.',
    ...
    'mimes' => ':attribute должен быть файлом типа: :ценности.',
    'mimetypes' => ':attribute должен быть файлом типа: :ценности.',
    'min' => [
        'array' => ':attribute должен иметь как минимум элементы :min.',
    ...
    'required_array_keys' => 'Поле :attribute должно содержать записи для: :ценности.',
    ...
    'required_without_all' => 'Поле :attribute требуется, когда ни одно из значений :value отсутствует.',
    ...
    'starts_with' => ':attribute должен начинаться с одного из следующих: :ценности.',
    ...
    'username' => [
        'exists' => [
            'false' => 'Ваши данные не соответствует нашим записям.'
        ],
    ],
    'greater' => [
        'order_item' => [
            'count' => ':attribute не должен превышать количество заказа.'
        ],
        'gift' => [
            'balance' => ':attribute не должен превышать баланс подарочной карты.'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'certificate' => 'Файл',
        'start' => 'Время доставки',
        'end' => 'ԱռաքմանВремя доставки',
        'items' => 'Продукты',
        ...
        'orderId' => 'Заказ',
        'type' => 'Тип',
        'referralCode' => 'Реферал Код',
        'name' => 'Имя',
        'first_name' => 'Имя',
        'last_name' => 'Фамилия',
        'count' => 'Количество',
        'gift' => [
            'id' => 'Подарочная карта ID',
            'use' => 'ՕСумма, используемая',
        ]
    ],
